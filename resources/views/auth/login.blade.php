...
<div class="bg-white shadow-lg rounded-lg w-96 p-8">
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <button type="submit" class="w-full bg-green-600 hover:bg-green-700 text-white py-2 rounded">Đăng nhập</button>
    </form>

    <p class="text-center text-gray-600 mt-4">
        Chưa có tài khoản?
        <a href="{{ route('register') }}" class="text-green-700 hover:underline">Đăng ký</a>
    </p>
</div>
</body>
</html>
